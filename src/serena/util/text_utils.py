...
def search_text(
    ...
    if allow_multiline_match:
        ...
        for match in compiled_pattern.finditer(content):
            ...
            # Find the line numbers for the start and end positions (0-based, matching the rest of Serena's tools)
        ...
        for i, line in enumerate(lines):
            if compiled_pattern.search(line):
                # Calculate the range of lines to include in the context (0-based)
